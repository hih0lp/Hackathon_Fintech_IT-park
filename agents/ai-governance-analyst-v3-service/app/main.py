...
app = FastAPI(
    title="AI Governance Analyst v3 Agent",
    version="1.0.0",
    description="Streaming microservice that applies ai-governance-analyst-v3 skill and calls Anthropic Claude API.",
)
...
async def health() -> JSONResponse:
    return JSONResponse(
        {
            "status": "ok",
            "service": "ai-governance-analyst-v3-agent",
        }
    )
