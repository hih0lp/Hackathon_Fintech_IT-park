...
app = FastAPI(
    title="Ambiguilty Resolver 0lvl Agent",
    version="1.0.0",
    description="Streaming microservice that applies ambiguilty-resolver-0lvl skill and calls Anthropic Claude API.",
)
...
async def health() -> JSONResponse:
    return JSONResponse(
        {
            "status": "ok",
            "service": "ambiguilty-resolver-0lvl-agent",
        }
    )
