...
app = FastAPI(
    title="Financial Crime Integrity Agent",
    version="1.0.0",
    description="Streaming microservice that applies financial-crime skill and calls Anthropic Claude API.",
)
...
async def health() -> JSONResponse:
    return JSONResponse(
        {
            "status": "ok",
            "service": "financial-crime-integrity-agent",
        }
    )
