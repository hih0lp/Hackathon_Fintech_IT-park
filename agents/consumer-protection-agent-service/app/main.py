...
app = FastAPI(
    title="Consumer Protection Agent",
    version="1.0.0",
    description="Streaming microservice that applies consumer-protection skill and calls Anthropic Claude API.",
)
...
async def health() -> JSONResponse:
    return JSONResponse(
        {
            "status": "ok",
            "service": "consumer-protection-agent",
        }
    )
